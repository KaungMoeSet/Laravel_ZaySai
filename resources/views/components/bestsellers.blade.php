<x-blockcomp class="block-products block-products--layout--large-first">
    <div class="container">
            ...
            <div class="block-products__featured">
                <div class="block-products__featured-item">
                    <div class="product-card"><button class="product-card__quickview" type="button"><svg width="16px" height="16px">
                        ...
                        <div class="product-card__image"><a href="product.html"><img src="/frontend/images/products/product-1.jpg" alt=""></a></div>
                        ...
                        <div class="product-card__actions">
                            ...
                            <div class="product-card__buttons product-btn"><button class="btn btn-primary product-card__addtocart" type="button">Add To
                                    Cart</button>
                            </div>
                        </div>
                    </div>
