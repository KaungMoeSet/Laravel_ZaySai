<x-blockcomp data-layout="horizontal">
    <div class="container">
                        ...
                        <div class="product-card">
                            ...
                            <div>
                                ...
                                <div class="product-card__actions">
                                    ...
                                    <div class="product-card__buttons">
                                    <button class="btn btn-secondary product-card__buynow" type="button">
                                            Buy Now
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg width="16px" height="16px">
                            ...
                            <div class="product-card__image"><a href="product.html">
                                    <img src="/frontend/images/products/product-2.jpg" alt=""></a>
                            </div>
                            <div>
                                <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    ...
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg width="16px" height="16px">
                            ...
                            <div>
                                <div class="product-card__info">
                                    <div class="product-card__name"><a href="product.html">
                                            Water Hose 40cm abcd fefe</a>
                                    </div>
                                </div>
                                <div class="product-card__actions">
                                    <div class="product-card__availability">Availability: <span class="text-success">In Stock</span></div>
