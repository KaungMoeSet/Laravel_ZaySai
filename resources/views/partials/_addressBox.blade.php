...
<form method="POST" action="{{ route('address.store') }}" class="text-left" enctype="multipart/form-data">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="checkout-phone" placeholder="Please enter your phone number"
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="checkout-house" placeholder="Please Enter" name="building"
                value="{{ old('building') }}">
            @error('building')
                <span class="help-inline">
                    {{ $message }}
